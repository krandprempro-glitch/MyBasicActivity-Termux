...
public class MainActivity extends AppCompatActivity {
    ...
    private String currentDir = "/data/data/com.termux/files/home";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        outputText.setText("Terminal Ready.\n\n");
        ...
        runButton.setOnClickListener(view -> executeCommand());
        clearButton.setOnClickListener(view -> outputText.setText(""));
        linuxButton.setOnClickListener(view -> startLinux());
        
        // تشغيل Linux تلقائياً عند فتح التطبيق (أزل علامة // لتفعيل)
        // startLinux();
    }
    
    private void startLinux() {
        outputText.append("\n[Starting Linux...]\n");
        executeSystemCommand("pkg update -y && pkg upgrade -y");
        executeSystemCommand("pkg install proot-distro -y");
        executeSystemCommand("proot-distro install ubuntu");
        executeSystemCommand("proot-distro login ubuntu");
    }
    ...
    private void executeCommand() {
        ...
        new Thread(() -> {
            try {
                Process process = Runtime.getRuntime().exec(new String[]{
                    "/system/bin/sh", "-c", "cd " + currentDir + " && " + command
                });
